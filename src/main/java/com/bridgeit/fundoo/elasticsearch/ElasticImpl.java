...
@Service
public class ElasticImpl implements IElasticSearch {
	...
	public String updateNote(Note note) throws IOException {
		Note note2 = findById(String.valueOf(note.getNoteid()));
		UpdateRequest request = new UpdateRequest(INDEX, TYPE, String.valueOf(note2.getNoteid()));
